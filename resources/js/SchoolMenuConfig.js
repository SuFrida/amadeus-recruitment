  ...
  },
  {
    ...
    submenu: [
      { 
        ...
        routeName: 'finance.balance.show', 
        permissionName: 'finance.balance.show'
      },
      { 
        label: 'Ingresos',
        routeName: 'finance.income.show',
        permissionName: 'finance.income.show'
      },
      { 
        label: 'Gastos',
        routeName: 'finance.outcome.show',
        permissionName: 'finance.outcome.show'
      },
    ],
  },
  {
...
export default SchoolMenuConfig